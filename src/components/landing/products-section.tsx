          ...
          <div className="relative rounded-3xl border border-slate-200 overflow-hidden group hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="bg-white px-8 py-7 -mt-8 rounded-t-3xl relative z-10">
              ...
              <div className="flex items-center justify-between pt-5 border-t border-slate-100">
                ...
                <button className="bg-[#050040] hover:bg-slate-800 text-white text-sm font-semibold px-5 py-2.5 rounded-xl transition">
                  Reservar
                </button>
              </div>
            </div>
          ...
          <div className="relative rounded-3xl border border-slate-200 overflow-hidden group hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="bg-white px-8 py-7 -mt-8 rounded-t-3xl relative z-10">
              ...
              <div className="flex items-center justify-between pt-5 border-t border-slate-100">
                ...
                <button className="bg-amber-500 hover:bg-amber-600 text-white text-sm font-semibold px-5 py-2.5 rounded-xl transition">
                  Descargar
                </button>
              </div>
            </div>
